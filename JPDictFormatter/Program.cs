...
namespace JPDictFormatter
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //var result = formatter.ParseExplanationString("\n（英）overtimemoney\n加班费");
            //var grouped = formatter.CreateGroupedList(result, 50);
            ////ひ\n\n火\n[ 名 ] 火；火焰；灯光；火警；火灾；愤怒之火\n\nか\n\n火\n[ 名 ] 火（五行之一）
            //foreach (var i in grouped)
            //{
            //    System.Diagnostics.Debug.WriteLine(i.DefinitionId + ", " + i.ItemId + ", " + i.Reading + ", " + i.Keyword + ", " + i.LoanWord + ", " + i.Pos + ", " + i.Definition + ", " + i.SeeAlso);
            //}
            //Console.ReadLine();
